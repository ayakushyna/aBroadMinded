        ...
        methods: {
            ...
            fetchData(page) {
                try {
                    ...
                    axios.get(this.$route.meta.api.profiles + '/'+ this.$route.params.id + '/' + this.show + '/' + '?page=' + page, {
                        params: {
                        ...
                        .then(response => {
                            ...
                            let fields = response.data.fields.filter(field => field.key !== 'fullname');
                            for(let i in fields){
            ...
            async deleteItem(id) {
                if(this.show === 'properties'){
                    this.axios
                        .delete(this.$route.meta.api.properties + '/'+ id)
                        .then(response => {
