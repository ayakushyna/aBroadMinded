...
<script>
    ...
    export default {
        ...
        methods: {
            createProfile(id){
                axios.post(this.$route.meta.api.profiles, {
                    ...
                    .then(response => {
                        ...
                        this.form.profile_id = response.data.items.id;
                        console.log(this.form.profile_id)
                        this.$router.push({name: 'ProfileEdit', params: {id: this.form.profile_id}});
                    })
                    .catch(errors => {
                        console.log(errors)
                    })
            ...
            onSubmit(evt) {
                axios.post(this.$route.meta.api.users, {
                    ...
                    .then(response => {
                        this.form.user_id = response.data.items.id
                        console.log(this.form.user_id)
                        this.createProfile(this.form.user_id)
                    })
                    .catch(errors => {
                        console.log(errors)
                    })
